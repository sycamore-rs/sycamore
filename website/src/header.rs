...
#[component]
fn DarkModeToggle<G: Html>(ctx: ScopeRef, _: ()) -> View<G> {
...
#[component]
fn Nav<G: Html>(ctx: ScopeRef, _: ()) -> View<G> {
    view! { ctx,
...
#[component]
pub fn NavLinks<G: Html>(ctx: ScopeRef, _: ()) -> View<G> {
...
#[component]
pub fn HamburgerMenu<G: Html>(ctx: ScopeRef, _: ()) -> View<G> {
