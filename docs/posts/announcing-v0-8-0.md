...
The reactive scope is no longer implicitly tracked through global variables but
...
As an added benefit, we also get completions (intellisense) support for HTML
