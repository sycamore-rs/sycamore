...
Begin with creating a fork of the sycamore repository and clone it to your
machine.
...
version of Rust (currently 1.93).
...
```bash
RUN_UI_TESTS=true TRYBUILD=overwrite cargo +1.93 test
```
